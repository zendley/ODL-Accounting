  ...
  <section class="content">
      ...
      <div class="container">
          ...
          <ul class="responsive-table" style="margin-right: 20px">
            ...
            <form class="quoform" action="/suppliers/update/{{$data->id}}" method="post">
                @csrf
                <div class="form-row">
                ...
                <div class="form-group">
                  ...
                  <input required type="text" class="form-control" id="supplier_name" name="supplier_name" placeholder="" value="{{$data->supplier_name}}">
                </div>
                <div class="form-group">
                  <label for="inputAddress2">Company Name</label>
                  <input required type="text" class="form-control" id="Company_name" name="Company_name" placeholder="" value="{{$data->Company_name}}">
                </div>
                <div class="form-row">
                  
                  <div class="form-group col-md-6">
                    <label for="inputCity">Phone No.</label>
                    <input required type="number" class="form-control" id="phone" name="phone_number" value="{{$data->phone_number}}" >
                  </div>
                  <div class="form-group col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input required type="text" class="form-control" id="address" name="address" value="{{$data->address}}" >
                  </div>
