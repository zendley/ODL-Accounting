  ...
  <section class="content">
      ...
      <div class="container">
          ...
          <ul class="responsive-table" style="margin-right: 20px">
            ...
            <form class="quoform" action="/quote/update/{{$datas->id}}" method="post">
                @csrf
                <div class="form-row">
                        
                    <div class="form-group col-md-6">
                        <label for="">Quote No.</label>
                        <input disabled type="id" class="form-control" placeholder="Quote No." value="{{$datas->id}}">
                    </div>
               ...
               <div>
                   ...
                   <div class="form-row prod">                   
                       ...
                       <div class="form-group col-md-6">
                         ...
                         <input type="text" class="form-control" id="text" required name="product[]" placeholder="product Name" value="{{$dataa->product}}">
                         <span style="color: red">
                            @error('product[]')
                              {{$message}}*
                            @enderror
                       ...
                       <div class="form-group col-md-3">
                           ...
                           <input type="number" class="form-control" required id="phone" name="quantity[]" value="{{$dataa->quantity}}">
                           <span style="color: red">
                            @error('quantity[]')
                              {{$message}}*
                            @enderror
                       ...
                       <div class="form-group col-md-3">
                           ...
                           <input type="number" class="form-control" required id="phone" name="unit_price[]" value="{{$dataa->unit_price}}">
                           <span style="color: red">
                            @error('unit_price[]')
                              {{$message}}*
                            @enderror
