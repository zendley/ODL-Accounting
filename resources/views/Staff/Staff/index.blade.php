                ...
                <table class="table " id="datatable" style="background-color: white; text-align: center;">
                    ...
                    <tr >
                        ...
                        <td>
                            ...
                            <a type="button" class="" style="border-radius: 0px; color:black" href="/staff/edit/{{$data->id}}">
                            <i class="fas fa-fw fa-edit"></i>
                            </a>
                            <a type="button" class="" style="border-radius: 0px; color:black" href="/staff/delete/{{$data->id}}">
