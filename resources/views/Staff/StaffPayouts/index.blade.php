      ...
      <div class="container">
          ...
          <ul class="responsive-table" >
              <div style="display: flex">
                <div class="buttons">
                    <form action="/staff_payout/add">
                        <button type="submit" style="width: 183px">Add Staff Payout</button>
                    </form>
                </div>
                ...
                <table class="table " id="datatable" style="background-color: white; text-align: center;">
                    ...
                    <tr style="border-radius: 50px;">
                        <th style="width: 250px;height:auto;">Staff Name</th>
                        <th >date</th>
                        <th >Total Wage</th>
                        <th >Paid Wage</th>
                    ...
                    <tr >
                        ...
                        <?php $totwages=App\Models\staffwage::where('staff_name','=',$data->staff_name)->get('total_wage'); ?>
                        
                        @foreach ($totwages as $totwage)
                        
                        <td >{{$apst->currency}}.{{$totwage->total_wage}}</td>
                            
                        
                        
                        <td >{{$apst->currency}}.{{$data->paid_wage}}</td>
                        <td >{{$apst->currency}}.{{$totwage->total_wage - $data->paid_wage}}</td>
                        @endforeach
                        <td>
                            ...
                            <a type="button" class="" style="border-radius: 0px; color:black" href="/staff_payout/edit/{{$data->id}}">
                            <i class="fas fa-fw fa-edit"></i>
                            </a>
                            <a type="button" class="" style="border-radius: 0px; color:black" href="/staff_payout/delete/{{$data->id}}">
