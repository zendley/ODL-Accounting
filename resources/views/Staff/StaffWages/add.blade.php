  ...
  <section class="content">
      ...
      <div class="container">
          ...
          <ul class="responsive-table" style="margin-right: 20px">
            ...
            <form class="quoform" action="/staff_wages/save" method="post">
                @csrf
                <div class="form-row">
                ...
                <div class="form-group">
                    <label for="inputCity">Wage</label>
                      <input type="number" class="form-control" id="phone" name="wage" >
                      <span style="color: red">
                        @error('wage')
                          {{$message}}*
                        @enderror
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <select id="supplier_name" name="duration_id" class="form-control">
                        ...
                        @foreach ($datas as $data)
                          <option value="{{$data->id}}">{{$data->duration_time}}</option>    
                        @endforeach
                      </select>
                      <span style="color: red">
                        @error('duration_id')
