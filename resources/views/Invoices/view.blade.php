...
<div class="container-fluid">
    ...
    <div style="display: flex">
        ...
        <div style="display: flex; margin-left: auto;">
            ...
            <div class="buttons" style="margin-left: 10px;">
                    <button type="button" onclick='pdfDiv();' >Download PDF</button>
            </div>
          </div>
      </div>
    ...
    <div class="invoice p-3 mb-3" id="DivIdToPrint">
        ...
        <div class="row" >
            ...
            <div class="col-6">
                ...
                <div class="float-right">
                    ...
                    @if ($apst->company_logo != '')
                    <img 
                    style="max-height: 16em; width: 100%;"
                    src="{{asset('storage/logos/'.$apst->company_logo)}}"
                    alt="Re-Ulpoad Your Image">
                    @endif
        ...
        <div class="row" style="margin: 2em 0em;">
            ...
            <div class="col-6">
                <div class="float-right">
                    <b style="color: #BB292A">Invoice No: </b>{{$datas->id}}<br>
                    <br>
                    {{-- <b>Order ID:</b> 4F3S8J --}}
                    <br>
