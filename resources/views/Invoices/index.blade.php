          ...
          <ul class="responsive-table" >
              <div style="display: flex">
                ...
                <table class="table table-hover " id="datatable" style="background-color: white; text-align: center;">
                    ...
                    <tr class="include" data-link="/invoices/{{$data->id}}">
                        <td >{{$data->id}}</td>
                        ...
                        <td class="exclude">
                                ...
                                <a type="button" class="" style="border-radius: 0px; color:black" href="/invoices/edit/{{$data->id}}">
                                <i class="fas fa-fw fa-edit"></i>
                                </a>
                                <a type="button" class="" style="border-radius: 0px; color:black" href="/invoices/delete/{{$data->id}}">
