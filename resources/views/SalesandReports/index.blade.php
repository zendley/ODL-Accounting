      ...
      <div class="container">
          ...
          <ul class="responsive-table">
              <div style="display: flex">
                <div class="buttons">
                    <form action="/salesandreports/addsale">
                        <button type="submit" >Add Sale</button>
                    </form>
                </div>
                <div class="buttons" style="margin-left: 10px;">
                    <form action="/salesandreports/addexpense">
                ...
                <div style="display: flex; margin-left: auto;">
                  ...
                  <table class="table " id="datatable" style="background-color: white; text-align: center;">
                    ...
                    <tr style="border-radius: 50px;">
                        ...
                        <th >Sale Name</th>
                        <th style="max-width: 500px;height:auto;" >Amount</th>
                        <th >Type</th>
                    ...
                    <tr >
                        ...
                        <td >{{$apst->currency}}.{{$data->amount}}</td>
                        <td >{{$data->type}}</td>
                        ...
                        <td>
                            ...
                            <a type="button" class="" style="border-radius: 0px; color:black" href="/salesandreports/edit/{{$data->id}}">
                            <i class="fas fa-fw fa-edit"></i>
                            </a>
                            <a type="button" class="" style="border-radius: 0px; color:black" href="/salesandreports/delete/{{$data->id}}">
