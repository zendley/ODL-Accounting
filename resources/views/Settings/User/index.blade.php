        ...
        <table class="table " id="datatable" style="background-color: white; text-align: center;">
          ...
          <tr >
              ...
              <td>
                  ...
                  <a type="button" class="" style="border-radius: 0px; color:black" href="/user/edit/{{$user->id}}">
                  <i class="fas fa-fw fa-edit"></i>
                  </a>
                  <a type="button" class="" style="border-radius: 0px; color:black" href="/user/delete/{{$user->id}}">
